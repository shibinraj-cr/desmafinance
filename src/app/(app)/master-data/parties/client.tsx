...
export function PartiesEditor({ parties }: { parties: Party[] }) {
          ...
          <table className="w-full text-body-md">
            <thead className="bg-surface-container-low text-on-surface-variant">
              <tr className="text-left">
                ...
                <th className="px-md py-sm text-label-sm uppercase tracking-wider">Email / Phone</th>
  ...
  return (
    <>
      ...
      >
        ...
        <td className="px-md py-sm text-right font-mono">{party.txCount}</td>
      ...
      {editing && error && (
        <tr>
          <td colSpan={6} className="px-md pb-sm">
...
export function NewPartyButton() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    setOpen(false);
    setForm({ name: "", group: "Candidate", txTypes: "Both", email: "", phone: "", notes: "" });
    router.refresh();
  }
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-md">
                <Field label="Group">
                  <select
                    value={form.group}
                    onChange={(e) => setForm({ ...form, group: e.target.value as PartyGroup })}
                    className={inputCls}
                  >
                    <option value="Candidate">Candidate</option>
                    <option value="Vendor">Vendor</option>
